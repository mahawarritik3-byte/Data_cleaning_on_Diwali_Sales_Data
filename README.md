...
The goal of this analysis is to understand customer purchasing behavior during the Diwali festival season and extract meaningful business insights from the sales data.

📂 Dataset Information

Dataset Name: Diwali_Sales_Data.csv
